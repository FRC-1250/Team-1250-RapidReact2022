...
public class BallPickupAndHighShot2Ball extends SequentialCommandGroup {
  /** Creates a new BallPickupAndShoot. */

  public BallPickupAndHighShot2Ball(Intake cmd_intake, Shooter cmd_Shooter, Drivetrain cmd_drivetrain, Sorter cmd_sorter) {
    addCommands(
