...
public class BallPickupAndHighShotTerminalSide extends SequentialCommandGroup {
  /** Creates a new BallPickupAndHighShotTerminalSide. */
  public BallPickupAndHighShotTerminalSide(Intake cmd_intake, Shooter cmd_Shooter, Drivetrain cmd_drivetrain, Sorter cmd_sorter) {
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            new SequentialCommandGroup(
                new DriveToPositionByInches(cmd_drivetrain, 30),
                new WaitCommand(1),
                new RetractIntake(cmd_intake))),
        new DriveToPositionByInches(cmd_drivetrain, -20),
        new TurnToHeading(cmd_drivetrain, 180),
