...
public class TwoBallHighHangarSide extends SequentialCommandGroup {
  /** Creates a new BallPickupAndShoot. */

  public TwoBallHighHangarSide(Intake cmd_intake, Shooter cmd_Shooter, Drivetrain cmd_drivetrain, Sorter cmd_sorter) {
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            new SequentialCommandGroup(
                new DriveToPositionByInches(cmd_drivetrain, 45),
                new WaitCommand(1),
                new DriveToPositionByInches(cmd_drivetrain, -28),
